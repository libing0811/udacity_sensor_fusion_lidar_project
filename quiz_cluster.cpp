...
void proximity(std::vector<int>& cluster,int id,std::vector<bool>& processed ,KdTree * tree,const std::vector<std::vector<float>>& points,float distanceTol){
...
std::vector<std::vector<int>> euclideanCluster(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol)
{
  ...
  for( int i =0 ;i < points.size();i++){
    ...
    proximity(cluster, i, processed , tree, points, distanceTol);
